    ...
    switch (actionType) {
      case "confirm":
        return {
          ...
          message:
            "Are you sure you want to confirm this reservation? This will mark it as active and notify the customer.",
      ...
      case "unpaid":
        return {
          ...
          message:
            "Are you sure you want to mark this reservation as unpaid? This will make the vehicle available for other reservations.", // Updated message
      ...
      case "complete":
        return {
          icon: <CheckCircle className="h-10 w-10 text-green-500" />, // Changed from green to purple
          title: "Mark Reservation as Complete", // Changed title
          message:
            "Are you sure you want to mark this reservation as Complete? This will make the vehicle available for other reservations.", // Updated message
          buttonColor: "bg-green-500 hover:bg-green-600", // Changed from green to purple
          buttonText: "Yes, Mark as Complete", // Updated button text
        };
      case "cancel":
        return {
          ...
          message:
            "Are you sure you want to cancel this reservation? This will make the vehicle available for other customers.",
