...
export default function ReservationDetailsPage({
    ...
    async function fetchReservationDetails() {
      ...
      try {
        const response = await fetch(
          `${API_BASE_URL}/rents/${params.reservationId}`,
          {
            headers: {
  ...
  const calculateLateFees = (reservation: any) => {
    ...
    const lateFeePerDay = reservation.car.tier
      ? (reservation.car.tier + 1) * 500
      : 500;
  ...
  // Calculate late fees
  const { daysLate, lateFeePerDay, totalLateFee } =
    calculateLateFees(reservation);
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatCurrency(reservation.car.dailyRate)}/day
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">
                    {getTierName(reservation.car.tier)} (Tier{" "}
                ...
                {(reservation.status === "pending" ||
                  ...
                  <div className="flex space-x-2">
                    {!isEditingInfo ? (
                      <button
                        onClick={() => {
                          setEditedInfo(reservation.notes || "");
              ...
              <div className="space-y-2">
                ...
                <p className="flex justify-between">
                  ...
                  reservation.additionalCharges > 0 ? (
                    <span className="text-red-600">
                      {formatCurrency(reservation.additionalCharges)}
                    </span>
                  ) : (
        ...
        {(reservation.status === 'pending' || session?.user?.role === 'admin') && (
          <div className="mt-8 flex justify-center space-x-4">
            <button 
              ...
              disabled={isLoading}
              className="px-6 py-3 bg-red-500 text-white rounded-md hover:bg-red-600 disabled:opacity-50 shadow-md hover:shadow-lg flex items-center justify-center transform hover:-translate-y-0.5 transition-all duration-200"
            >
              {isLoading ? (
                <>
