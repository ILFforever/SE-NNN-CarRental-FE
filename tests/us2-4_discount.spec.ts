...
test('should see discount on booking summary', async ({ page }) => {
  ...
  await page.locator('[data-test-id="catalog"] div').filter({ hasText: '$2.00/dayconvertiblePlaywright Hand2025 • Playwright TestVerifiedRated by 12' }).getByRole('button').nth(3).click();
